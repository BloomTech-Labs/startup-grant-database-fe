...
var Auth0Client = /** @class */ (function () {
    ...
    Auth0Client.prototype.getTokenSilently = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var audience, scope, ignoreCache, additionalQueryParams, cache, stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, authorizeOptions, params, url, codeResult, authResult, decodedToken, cacheEntry, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options.scope = getUniqueScopes(this.DEFAULT_SCOPE, options.scope);
                    ...
                    case 1:
                        ...
                        audience = options.audience, scope = options.scope, ignoreCache = options.ignoreCache, additionalQueryParams = __rest(options, ["audience", "scope", "ignoreCache"]);
                        if (!ignoreCache) {
